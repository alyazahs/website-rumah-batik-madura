...
<aside class="w-64 bg-indigo-800 text-white flex flex-col p-4 min-h-screen">
    ...
    <nav class="space-y-2 text-sm">
        <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 hover:bg-indigo-600 rounded">
        ...
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open" class="mt-1 ml-4 space-y-1" x-cloak>
                <a href="{{ route('profile.edit') }}" class="block px-4 py-1 hover:bg-indigo-600 rounded">My Profile</a>
