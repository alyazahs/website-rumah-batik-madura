...
<div class="container mx-auto px-6 py-10">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
            <h1 class="text-3xl font-bold text-blue-600">Tentang Kami</h1>
            ...
            <div class="mt-6 p-5 bg-gray-100 rounded-lg shadow-md">
                ...
                <ul class="space-y-2 text-gray-600">
                    <li><i class="text-red-500 mr-2">📍</i> <strong>Alamat:</strong> Jl. Hercules Perum Bumi Antariksa No.E37, Klegen, Kec. Kartoharjo, Kota Madiun, Jawa Timur</li>
                    <li><i class="text-yellow-500 mr-2">⏰</i> <strong>Jam Operasional:</strong> Senin - Minggu (06.00 - 17.00 WIB)</li>
                    <li><i class="text-green-500 mr-2">📞</i> <strong>Kontak:</strong> 0878-3032-5994</li>
                    <li><i class="text-blue-500 mr-2">📸</i> <strong>Instagram:</strong> @rumah.batik.madura</li>
                </ul>
            </div>
        </div>

        <div>
            <h3 class="text-xl text-green-600 font-semibold text-center mb-4">Lokasi Kami</h3>
